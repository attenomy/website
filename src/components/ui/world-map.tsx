...
export default function WorldMap({
  ...
  const currentLineColor = lineColor || (currentTheme === "dark" ? "#ffffff" : "#000000");

  // Regenerate SVG when theme changes
  useEffect(() => {
  ...
  // Don't render until we have the SVG
  if (!svgMap) {
    return (
      ...
      >
        ...
        <defs>
          <linearGradient id="path-gradient" x1="0%" y1="0%" x2="100%" y2="0%">
            ...
            <stop offset="5%" stopColor={currentLineColor} stopOpacity="1" />
            <stop offset="95%" stopColor={currentLineColor} stopOpacity="1" />
