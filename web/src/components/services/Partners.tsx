...
export function Partners({
  ...
  return (
    <div
      ...
      style={{ height }}
    >
      <h2 className="text-3xl md:text-4xl lg:text-6xl font-semibold max-w-7xl mx-auto relative z-20 pb-2 pt-12 bg-clip-text text-transparent bg-gradient-to-b from-neutral-800 to-neutral-700 dark:from-neutral-800 dark:via-neutral-700 dark:to-white">
        Our Partners
      </h2>
