    ...
    return (
        <div className="py-20 dark:bg-black bg-white w-full px-6">
          <div className="max-w-7xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl lg:text-6xl font-semibold max-w-7xl mx-auto relative z-20 pb-6 px-4 bg-clip-text text-transparent bg-gradient-to-b from-neutral-800 via-neutral-700 to-neutral-700 dark:from-neutral-800 dark:via-white dark:to-white">
                Innovating 24/7
            </h2>
