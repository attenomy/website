          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 2,
                "name": "Contact",
                "item": "https://attenomy.com/contact"
              }
            ]
          })
        }}
          ...
          <div className="lg:col-span-1 space-y-8">
            <div>
              ...
              <p className="text-muted-foreground mb-6">
                Have a project in mind? Interested in our services? Reach out and our team will get back to you within 24 hours.
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <p className="text-muted-foreground">For business inquiries</p>
                    <a
                      href="mailto:business@attenomy.com"
                      className="text-primary hover:underline font-medium"
                    >
                      business@attenomy.com
                    </a>
                  </div><div>
                    <p className="text-muted-foreground">For technical support</p>
                    <a
                      href="mailto:support@attenomy.com"
                      className="text-primary hover:underline font-medium"
                    >
                      support@attenomy.com
                    </a>
                  </div>
                </div>
